...
8. 建议一个优先关注的模块数量 (module_count_suggestion)，不超过20个，基于主要模块的数量。
9. 确保模块定义逻辑独立，避免过细的拆分（如单独的标题或段落，除非有明确语义），但是图表窗口最好可以拆开来。
...
<body>
    ...
    <nav><ul><li>首页</li><li>产品</li><li>联系</li></ul></nav>
    <div class="main-area">
        <main>
            <h2>主要内容</h2>
            <p>这是主要内容的第一段。</p>
        </main>
        <aside><h3>侧边栏</h3><p>侧边栏内容。</p></aside>
    </div>
...

{
  ...
  "definitions": [
    ...
    {
      "id": "nav_module",
      "description": "导航区域，包含菜单列表",
      "start_comment": "LLM_MODULE_START: nav_module",
      "end_comment": "LLM_MODULE_END: nav_module",
      "start_line": 13,
      "end_line": 13,
      "start_char": 301,
      "end_char": 360
    ...
    {
      "id": "main_area_module",
      "description": "主要内容和侧边栏的容器",
      "start_comment": "LLM_MODULE_START: main_area_module",
      "end_comment": "LLM_MODULE_END: main_area_module",
      "start_line": 14,
      "end_line": 18,
      "start_char": 361,
      "end_char": 551
    },
    {
      "id": "main_module",
      "description": "主要文章区域",
      "start_comment": "LLM_MODULE_START: main_module",
      "end_comment": "LLM_MODULE_END: main_module",
      "start_line": 15,
      "end_line": 17,
      "start_char": 378,
      "end_char": 456
    },
    {
      "id": "aside_module",
      "description": "侧边栏区域",
      "start_comment": "LLM_MODULE_START: aside_module",
      "end_comment": "LLM_MODULE_END: aside_module",
      "start_line": 18,
      "end_line": 18,
      "start_char": 457,
      "end_char": 510
